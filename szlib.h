...
#define SZ_NULL  0  /* for initializing zalloc, zfree, opaque */

#define szlib_version szlibVersion()
/* for compatibility with versions < 1.0.2 */

                        /* basic functions */

SZEXTERN const char * SZEXPORT szlibVersion OF((void));
...
/* 
SZEXTERN int SZEXPORT deflateInit OF((sz_streamp strm, int level));

     Initializes the internal stream state for compression. The fields
   zalloc, zfree and opaque must be initialized before by the caller.
   If zalloc and zfree are set to SZ_NULL, deflateInit updates them to
...
#define SZ_PARTIAL_FLUSH 1 /* will be removed, use Z_SYNC_FLUSH instead */
#define SZ_SYNC_FLUSH    2
#define SZ_FULL_FLUSH    3
#define SZ_FINISH        4
...
#define SZ_ERRNO        (-1)
#define SZ_STREAM_ERROR (-2)
#define SZ_DATA_ERROR   (-3)
#define SZ_MEM_ERROR    (-4)
#define SZ_BUF_ERROR    (-5)
#define SZ_VERSION_ERROR (-6)
#define SZ_INIT_ERROR   (-7)

#define szfree free
#define szalloc malloc
...
typedef sz_stream FAR *sz_streamp;
